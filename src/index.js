...
export default {
  async fetch(request, env) {
    ...
    if (url.pathname === '/api/ai') {
      ...
      const aiResponse = await fetch('https://api.groq.com/openai/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            { role: 'system', content: 'You are 67 AI, the fast meme-culture assistant inside 67 Royale. Be concise, playful, useful, and distinguish guesses from facts.' },
            ...safeMessages
          ],
          temperature: 0.7,
          max_tokens: 700
    ...
    return new Response('67 Royale', { headers: { 'content-type': 'text/plain; charset=utf-8' } });
  }
};
